...
function PhotosUploader({ addedPhotos, onChange }) {
 ...
 component. It is used to update the list of added photos when a new photo is uploaded. */
  ...
  /**
   * The function `removePhoto` removes a photo from an array of added photos.
   */
  ...
  /**
   * The function `selectAsMainPhoto` updates the order of photos by moving the selected photo to the
   * front of the list.
   */
      ...
      <div className=" grid grid-cols-3 gap-4 mt-2 md:grid-cols-4 lg:grid-col-6">
        {addedPhotos.length > 0 &&
          addedPhotos.map((link) => (
            <div className="h-44 flex relative" key={link}>
              <img
              ...
              <button
                ...
                className="absolute bottom-1 right-1 text-white bg-opacity-50 bg-black py-2 px-3 cursor-pointer rounded-xl"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1 left-1 text-white bg-opacity-50 bg-black py-2 px-3 cursor-pointer rounded-xl"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
